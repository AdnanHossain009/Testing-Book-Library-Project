...
public class Already_Read_Book_Activity extends AppCompatActivity {

    public static final String ALREADY_READ = "alreayRead";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Books You Already Read");
        ...
        books_rec_view_adapter adapter = new books_rec_view_adapter(this,ALREADY_READ);
        ...
        adapter.setBooks(Utils.getInstance(this).getAlready_Read_Books());
    }
