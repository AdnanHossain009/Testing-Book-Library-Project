...
public class Want_To_Read_Activity extends AppCompatActivity {

    public static final String WANT_TO_READ = "wantToRead";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Your Wishlist");
        ...
        books_rec_view_adapter adapter = new books_rec_view_adapter(this,WANT_TO_READ);
        ...
        adapter.setBooks(Utils.getInstance(this).getWant_to_read_books());
    }
