...
public class Favourite_Books_Activity extends AppCompatActivity {

    public static final String FAVOURITE_BOOKS = "favouriteBooks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Favourite Books");
        ...
        books_rec_view_adapter adapter = new books_rec_view_adapter(this,FAVOURITE_BOOKS);

        recyclerView.setAdapter(adapter);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        adapter.setBooks(Utils.getInstance(this ).getFavourite_books());
    }
